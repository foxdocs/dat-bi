...
def readTabData(tab):
        ...
        st.write('Two of dataframe attributes (columns) will be used as (independent) dimensions for exploring the dynamics of a third (dependent) one, called measure.')
