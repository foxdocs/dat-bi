...
st.image(Image.open('./Data/Unsupervised - Clustering/Silhouette Analysis.png'), use_column_width=True)
...
st.image(Image.open("./Data/Unsupervised - Clustering/Bounderies of clusters.png"), use_column_width=True)

st.write("And mapped out the silhouette score, to take a look at whether the clusters were good or not.")

st.image(Image.open("./Data/Unsupervised - Clustering/Silhouette Plot of KMeans.png"), use_column_width=True)
